...
public class McVirtualVerticalAxisTests {
    ...
    public void OffsetUnits_ShouldBeClamped() {
        var axis = new McVirtualVerticalAxis();
        axis.ContentUnits = 100;
        axis.ViewportPixels = 50;
        axis.PixelsPerUnit = 10;
    ...
    [Fact]
    public void ZoomToFit_ShouldAdjustPixelsPerUnit() {
        var axis = new McVirtualVerticalAxis();
        axis.ContentUnits = 100;
        axis.ViewportPixels = 50;
        ...
        axis.PixelsPerUnit.Should().Be(0.5); // 50 / 100
    }
}